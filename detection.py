...
class Detect(nn.Module):
    ...
    def forward(self, loc_data, conf_data, prior_data, num_classes=None, top_k=None, conf_thresh=None, nms_thresh=None, variance=None):
        """
        Args:
            ...
            variance: (tuple) Variance for decoding
        """
        # 使用传入的参数或默认值
